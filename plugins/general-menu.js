...
let tags = {}
const defaultMenu = {
  before: 'Hi, %name 👋\n\n• Date: %date\n• Time: %time WIB\n• Runtime: %uptime\n• Instagram: https://instagram.com/lippfnql\n %readmore',
  header: '*%category*',
...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    conn.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/c59c90dc7a9d2ff2b8916.mp4' }, gifPlayback: true, gifAttribution: ~~(Math.random() * 2), caption: text.trim() }, { quoted: m })
